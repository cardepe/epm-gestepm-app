                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                <label class="col-form-label w-100 bootstrap-select"><spring:message code="leaders"/>
                                    <select class="form-control select2" data-control="select2" name="userId" required></select>
                                </label>
                            </div>
                        </div>
                    </div>
