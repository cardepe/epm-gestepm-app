			...
			<div class="col-10">
				<div class="page-header float-left">
					<div class="page-title">
						<h1 class="text-uppercase"><spring:message code="projects.detail.title" arguments="${ project.name }" /></h1>
					</div>
				</div>
			</div>
			<div class="col-2">
				...
				<div class="row h-100">
					<div class="col-sm-12 col-md-3">
						<div class="nav flex-column nav-pills p-4" id="v-pills-tab" role="tablist" aria-orientation="vertical">
						  	<a class="nav-link" id="v-pills-customer-tab" data-toggle="pill" href="#v-pills-customer" role="tab" aria-controls="v-pills-customer" aria-selected="false"><spring:message code="project.detail.customer" /></a>
							<a class="nav-link" id="v-pills-displacements-tab" data-toggle="pill" href="#v-pills-displacements" role="tab" aria-controls="v-pills-displacements" aria-selected="false"><spring:message code="project.detail.displacements" /></a>
							<a class="nav-link" id="v-pills-equipments-tab" data-toggle="pill" href="#v-pills-equipments" role="tab" aria-controls="v-pills-equipments" aria-selected="false"><spring:message code="project.detail.equipments" /></a>
							<a class="nav-link" id="v-pills-signings-tab" data-toggle="pill" href="#v-pills-signings" role="tab" aria-controls="v-pills-signings" aria-selected="false"><spring:message code="project.detail.signings" /></a>
						  	<a class="nav-link" id="v-pills-messages-tab" data-toggle="pill" href="#v-pills-messages" role="tab" aria-controls="v-pills-messages" aria-selected="false"><spring:message code="project.detail.expends" /></a>
						  	<a class="nav-link active" id="v-pills-home-tab" data-toggle="pill" href="#v-pills-home" role="tab" aria-controls="v-pills-home" aria-selected="true"><spring:message code="project.detail.info" /></a>
						  	<a class="nav-link" id="v-pills-bosses-tab" data-toggle="pill" href="#v-pills-bosses" role="tab" aria-controls="v-pills-bosses" aria-selected="false"><spring:message code="project.detail.bosses.pill" /></a>
							<a class="nav-link" id="v-pills-materials-required-tab" data-toggle="pill" href="#v-pills-materials-required" role="tab" aria-controls="v-pills-materials-required" aria-selected="false"><spring:message code="project.detail.materials.required" /></a>
						  	<a class="nav-link" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false"><spring:message code="project.detail.users" /></a>
						</div>
					</div>
					<div class="col-sm-12 col-md-9 h-100 bg-light">
						<div class="tab-content" id="v-pills-tabContent">	
								...
								<form id="customerForm" class="needs-validation">
									<div class="row">
										...
										<div class="col text-right">
											<button id="saveCustomerBtn" type="button" class="btn btn-accent btn-sm"><spring:message code="save" /></button>
											<button id="editCustomerBtn" type="button" class="btn btn-standard btn-sm"><spring:message code="edit" /></button>
										</div>
									</div>
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												...
												<input id="customerName" name="customerName" type="text" class="form-control" value="${customer.name}" required readonly />
											</div>
										</div>
									</div>
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												...
												<input id="mainEmail" name="mainEmail" type="email" class="form-control" value="${customer.mainEmail}" readonly />
											</div>
										</div>
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<input id="secondaryEmail" name="secondaryEmail" type="email" class="form-control" value="${customer.secondaryEmail}" readonly />
											</div>
										</div>
									</div>
								</form>
							...
							<div class="tab-pane fade" id="v-pills-displacements" role="tabpanel" aria-labelledby="v-pills-displacements-tab">
						  		...
						  		<div class="row">
									...
									<div class="col text-right">
										<button type="button" class="btn btn-standard btn-sm" data-toggle="modal" data-target="#addDispModal"><spring:message code="project.detail.displacements.create" /></button>
									</div>
								</div>
								
								<div class="table-responsive">
									<table id="dTableDisplacements" class="table table-striped table-borderer dataTable w-100">
										...
										<thead>
											<tr>
												...
												<th id="thDispActivityCenter"><spring:message code="displacements.table.activity.center" /></th>
												<th id="thDispType"><spring:message code="displacements.table.displacement.type" /></th>
												<th id="thDispTotalTime"><spring:message code="displacements.table.total.time" /></th>
												<th id="thDispActions"><spring:message code="displacements.table.actions" /></th>
											</tr>
										</thead>
									</table>
								</div>
							...
							<div class="tab-pane fade" id="v-pills-equipments" role="tabpanel" aria-labelledby="v-pills-equipments-tab">
						  		...
						  		<div class="row">
									...
									<div class="col-8 text-right">
										<input type="file" id="importFamiliesInput" class="d-none" onchange="uploadFamiliesFile()" accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet" />
										<button type="button" class="btn btn-warning btn-sm text-white" onclick="importFamiliesFile()"><em class="fas fa-file-upload"></em> <spring:message code="project.detail.equipments.import.excel" /></button>
										<a href="/projects/${project.id}/families/export" target="_blank" class="btn btn-warning btn-sm text-white"><em class="fas fa-file-download"></em> <spring:message code="project.detail.equipments.export.excel" /></a>
										<button type="button" class="btn btn-standard btn-sm" data-toggle="modal" data-target="#createEquipmentModal"><spring:message code="project.detail.equipments.create" /></button>
									</div>
								</div>
						  	
						  		<div class="table-responsive">
								  	<table id="dTableEquipments" class="table table-striped table-borderer dataTable w-100">
										<caption class="d-none">
											NO SONAR
										</caption>
										<thead>
											<tr>
												...
												<th id="thNameES"><spring:message code="project.detail.equipments.name.es" /></th>
												<th id="thNameFR"><spring:message code="project.detail.equipments.name.fr" /></th>
												<th id="thBrand"><spring:message code="project.detail.equipments.brand" /></th>
												<th id="thModel"><spring:message code="project.detail.equipments.model" /></th>
												<th id="thEnrollment"><spring:message code="project.detail.equipments.enrollment" /></th>
												<th id="actions"><spring:message code="project.detail.equipments.actions" /></th>
											</tr>
										</thead>
									</table>
								</div>
							...
							<div class="tab-pane fade" id="v-pills-signings" role="tabpanel" aria-labelledby="v-pills-signings-tab">
						  		...
						  		<div class="table-responsive">
								  	<table id="dTableSignings" class="table table-striped table-borderer dataTable w-100">
										<caption class="d-none">
											NO SONAR
										</caption>
										<thead>
											<tr>
												...
												<th id="shareType"><spring:message code="shares.intervention.table.type" /></th>
												<th id="actions" class="all"><spring:message code="project.detail.signings.actions" /></th>
											</tr>
										</thead>
									</table>
								</div>
								...
								<div class="row">
						  		...
						  		<div class="table-responsive">
								  	<table id="dTableExpenses" class="table table-striped table-borderer dataTable w-100">
										...
										<thead>
											<tr>
												<th id="id"><spring:message code="project.detail.expenses.id" /></th>
												<th id="description"><spring:message code="project.detail.expenses.description" /></th>
												<th id="fullName"><spring:message code="project.detail.expenses.fullname" /></th>
												<th id="status"><spring:message code="project.detail.expenses.status" /></th>
												<th id="reportDate"><spring:message code="project.detail.expenses.reportdate" /></th>
												<th id="total"><spring:message code="project.detail.expenses.total" /></th>
												<th id="actions" class="all"><spring:message code="project.detail.members.actions" /></th>
											</tr>
										</thead>
									</table>
								</div>
							...
							<div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
								<form id="projectInfoForm" class="needs-validation">
									<div class="row">
										...
										<div class="col text-right">
											<button id="saveProjectBtn" type="button" class="btn btn-accent btn-sm"><spring:message code="save" /></button>
											<button id="editProjectBtn" type="button" class="btn btn-standard btn-sm"><spring:message code="edit" /></button>
										</div>
									</div>
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												...
												<input id="projectNameInfoInput" name="projectName" type="text" class="form-control" value="${project.name}" required readonly />
											</div>
										</div>
...
<!-- 												</select> -->
												...
												<select id="responsableInfoInput" class="form-control input selectpicker" data-style="defaultUserSelectPicker" data-live-search="true" multiple style="width: 100%" name="responsables" required disabled>
													<c:forEach items="${userDTOs}" var="userDTO">
														<option value="${userDTO.userId}" <c:if test="${jspUtil.existsInList(responsablesIds, userDTO.userId)}">selected</c:if>>
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<input id="objectiveCostInfoInput" name="objectiveCost" type="text" class="form-control" value="${project.objectiveCost}" required readonly />
											</div>
										</div>
									</div>
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												...
												<input id="startDateInfoInput" name="startDate" type="date" class="form-control" value="<fmt:formatDate value="${project.startDate}" pattern="yyyy-MM-dd" />" required readonly />
											</div>
										</div>
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<input id="objectiveDateInfoInput" name="objectiveDate" type="date" class="form-control" value="<fmt:formatDate value="${project.objectiveDate}" pattern="yyyy-MM-dd" />" required readonly />
											</div>
										</div>
									</div>
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												<label for="stationInfoInput" class="col-form-label"><spring:message code="projects.table.station" /></label>
												<select id="stationInfoInput" name="station" class="form-control" disabled>
													<option value="0" <c:if test="${project.station == 0}">selected</c:if>>
														<spring:message code="projects.table.station.none" />
													</option>
													<option value="1" <c:if test="${project.station == 1}">selected</c:if>>
										...
										<div class="col-md-6">
											<div class="form-group">
												<label for="forumIdDropdownInfoInput" class="col-form-label"><spring:message code="projects.table.forum" /></label>
												<select id="forumIdDropdownInfoInput" name="forumId" class="form-control" disabled>
													<option value="" <c:if test="${null == project.forumId}">selected</c:if>>
														<spring:message code="project.detail.forum.empty" />
													</option>
													<c:forEach items="${forumDTOs}" var="forumDTO">
														<option value="${forumDTO.id}" <c:if test="${forumDTO.id == project.forumId}">selected</c:if>>
							...
							<div class="tab-pane fade" id="v-pills-bosses" role="tabpanel" aria-labelledby="v-pills-bosses-tab">
						  		<div class="row">
						  			<div class="col">
								  		<div class="title mb-4 pb-2">
									...
									<div class="col text-right">
										<button type="button" class="btn btn-standard btn-sm" data-toggle="modal" data-target="#createBossModal"><spring:message code="project.detail.bosses.create" /></button>
									</div>
								</div>
						  	...
						  	<div class="tab-pane fade" id="v-pills-materials-required" role="tabpanel" aria-labelledby="v-pills-materials-required-tab">
						  		...
						  		<div class="row">
									...
									<div class="col text-right">
										<button type="button" class="btn btn-standard btn-sm" data-toggle="modal" data-target="#createMaterialRequiredModal"><spring:message code="project.detail.materials.required.create" /></button>
									</div>
								</div>
						  	
							  	<div class="table-responsive">
								  	<table id="dTableMaterialsRequired" class="table table-striped table-borderer dataTable w-100">
										<caption class="d-none">
											NO SONAR
										</caption>
										<thead>
											<tr>
												<th id="thId"><spring:message code="project.detail.table.materials.required.id" /></th>
												<th id="thNameES"><spring:message code="project.detail.table.materials.required.name.es" /></th>
												<th id="thNameFR"><spring:message code="project.detail.table.materials.required.name.fr" /></th>
												<th id="thRequired"><spring:message code="project.detail.table.materials.required.required" /></th>
												<th id="actions"><spring:message code="project.detail.table.materials.required.actions" /></th>
											</tr>
										</thead>
									</table>
								</div>
							...
							<div class="tab-pane fade" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
						  		...
						  		<div class="row">
									...
									<div class="col text-right">
										<button type="button" class="btn btn-standard btn-sm" data-toggle="modal" data-target="#createModal"><spring:message code="project.detail.members.create" /></button>
									</div>
								</div>
						  	
							  	<div class="table-responsive">
								  	<table id="dTableMembers" class="table table-striped table-borderer dataTable w-100">
										<caption class="d-none">
											NO SONAR
										</caption>
										<thead>
											<tr>
												...
												<th id="actions"><spring:message code="project.detail.members.actions" /></th>
											</tr>
										</thead>
									</table>
								</div>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form id="addMemberForm">
					<div class="row">
						<div class="col">
							<select id="memberDropdown" class="form-control input selectpicker" data-style="userSelectPicker" data-live-search="true" multiple style="width: 100%" name="memberId">
...
<div id="createBossModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<div class="modal-title">
			...
			<div class="modal-body">
				<form id="addBossForm">
					<div class="row">
						<div class="col">
							<select id="bossDropdown" class="form-control input selectpicker" data-style="userSelectPicker" data-live-search="true" multiple style="width: 100%" name="bossId">
...
<div id="createEquipmentModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form id="addEquipmentForm">
					<div class="row">
						<div class="col">
							<label for="familyDropdown" class="col-form-label"><spring:message code="shares.intervention.create.family" /></label>
					...
					<div class="row">
						<div class="col-sm-12 col-md-6">
							<div class="form-group">
								<label for="familyNameESInput" class="col-form-label"><spring:message code="families.admin.create.name.esp" /></label>
						...
						<div class="col-sm-12 col-md-6">
							<div class="form-group">
								<label for="familyNameFRInput" class="col-form-label"><spring:message code="families.admin.create.name.fra" /></label>
					...
					<div class="row">
						<div class="col-sm-12 col-md-6">
							<div class="form-group">
								<label for="brandInput" class="col-form-label"><spring:message code="families.admin.create.brand" /></label>
						...
						<div class="col-sm-12 col-md-6">
							<div class="form-group">
								<label for="modelInput" class="col-form-label"><spring:message code="families.admin.create.model" /></label>
					...
					<div class="row">
						<div class="col-sm-12 col-md-6">
							<div class="form-group">
								<label for="enrollmentInput" class="col-form-label"><spring:message code="families.admin.create.enrollment" /></label>
...
<div id="editEquipmentModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<div class="modal-title">
			...
			<div class="modal-body">
				<form id="editEquipmentForm">
					<div class="row">
						<div class="col">
							<label for="familyEditDropdown" class="col-form-label"><spring:message code="shares.intervention.create.family" /></label>
					...
					<div class="row">
						<div class="col-sm-12 col-md-6">
							<div class="form-group">
								<label for="familyNameESEditInput" class="col-form-label"><spring:message code="families.admin.create.name.esp" /></label>
								<input id="familyNameESEditInput" name="nameES" type="text" class="form-control" required>
							</div>
						</div>
						
						<div class="col-sm-12 col-md-6">
							<div class="form-group">
								<label for="familyNameFREditInput" class="col-form-label"><spring:message code="families.admin.create.name.fra" /></label>
								<input id="familyNameFREditInput" name="nameFR" type="text" class="form-control" required>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-sm-12 col-md-6">
							<div class="form-group">
								<label for="brandEditInput" class="col-form-label"><spring:message code="families.admin.create.brand" /></label>
						...
						<div class="col-sm-12 col-md-6">
							<div class="form-group">
								<label for="modelEditInput" class="col-form-label"><spring:message code="families.admin.create.model" /></label>
					...
					<div class="row">
						<div class="col-sm-12 col-md-6">
							<div class="form-group">
								<label for="enrollmentEditInput" class="col-form-label"><spring:message code="families.admin.create.enrollment" /></label>
...
<div id="createMaterialRequiredModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<div class="modal-title">
			...
			<div class="modal-body">
				<form id="addMaterialRequiredForm">
					...
					<div class="row">
						<div class="col-sm-12 col-md-6">
							<div class="form-group">
								<label for="materialRequiredNameESInput" class="col-form-label"><spring:message code="project.detail.table.materials.required.name.es" /></label>
								<input id="materialRequiredNameESInput" name="nameES" type="text" class="form-control" required>
							</div>
						</div>
						
						<div class="col-sm-12 col-md-6">
							<div class="form-group">
								<label for="materialRequiredNameFRInput" class="col-form-label"><spring:message code="project.detail.table.materials.required.name.fr" /></label>
								<input id="materialRequiredNameFRInput" name="nameFR" type="text" class="form-control" required>
							</div>
						</div>
					</div>
						...
						<div class="col-sm-12 col-md-6">
							<div class="form-group">
								<div class="form-check form-check-inline">
								  	<input type="checkbox" class="form-check-input" id="materialRequiredCheckbox" name="required" style="width: 20px; height: 20px">
								  	<label class="form-check-label" for="materialRequiredCheckbox"><spring:message code="project.detail.table.materials.required.required" /></label>
								</div>
							</div>
						</div>
					</div>
...
<div id="editMaterialRequiredModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<div class="modal-title">
			...
			<div class="modal-body">
				<form id="editMaterialRequiredForm">
					...
					<div class="row">
						<div class="col-sm-12 col-md-6">
							<div class="form-group">
								<label for="materialRequiredNameESEditInput" class="col-form-label"><spring:message code="project.detail.table.materials.required.name.es" /></label>
								<input id="materialRequiredNameESEditInput" name="nameES" type="text" class="form-control" required>
							</div>
						</div>
						
						<div class="col-sm-12 col-md-6">
							<div class="form-group">
								<label for="materialRequiredNameFREditInput" class="col-form-label"><spring:message code="project.detail.table.materials.required.name.fr" /></label>
								<input id="materialRequiredNameFREditInput" name="nameFR" type="text" class="form-control" required>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-sm-12 col-md-6">
							<div class="form-group">
								<div class="form-check form-check-inline">
								  	<input type="checkbox" class="form-check-input" id="materialRequiredEditCheckbox" name="required" style="width: 20px; height: 20px">
								  	<label class="form-check-label" for="materialRequiredEditCheckbox"><spring:message code="project.detail.table.materials.required.required" /></label>
								</div>
							</div>
						</div>
					</div>
...
<!-- VIEW CONST MODAL -->
<div id="viewConstModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<form id="viewConstForm" class="needs-validation">
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-sm-12 col-md-6">
							<label for="startDate" class="col-form-label"><spring:message code="shares.construction.start.date" /></label>
							<input type="datetime-local" class="form-control" id="startDate" name="startDate" readonly>
						</div>
						
						<div class="col-sm-12 col-md-6">
							<label for="endDate" class="col-form-label"><spring:message code="shares.construction.end.date" /></label>
					...
					<div class="row">
						<div class="col">
							<div class="form-group">
								<label for="observations" class="col-form-label"><spring:message code="shares.construction.description" /></label>
...
<!-- UPDATE CONST MODAL -->
<div id="updateConstModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
...
<!-- VIEW PROG MODAL -->
<div id="viewProgModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
...
<!-- UPDATE PROG MODAL -->
<div id="updateProgModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
...
<!-- VIEW DISP MODAL -->
<div id="viewDispModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
				...
				<div class="modal-body">		
					...
					<div class="row">
						...
						<div class="col-sm-12 col-md-6">
							...
							<input type="checkbox" class="form-control" id="roundTrip" name="roundTrip" style="width: 20px" readonly disabled>
						</div>
					</div>
...
<!-- VIEW WORK MODAL -->
<div id="viewWorkModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<form id="viewWorkForm" class="needs-validation">
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-sm-12 col-md-6">
							<label for="startDate" class="col-form-label"><spring:message code="shares.work.start.date" /></label>
							<input type="datetime-local" class="form-control" id="startDate" name="startDate" readonly>
						</div>
						
						<div class="col-sm-12 col-md-6">
							<label for="endDate" class="col-form-label"><spring:message code="shares.work.end.date" /></label>
							<input type="datetime-local" class="form-control" id="endDate" name="endDate" readonly>
						</div>
					</div>
					...
					<div class="row">
						<div class="col">
							<div class="form-group">
								<label for="observations" class="col-form-label"><spring:message code="shares.work.description" /></label>
								<textarea id="observations" name="observations" class="form-control" rows="6" readonly></textarea>
							</div>
						</div>
					</div>
...
<!-- UPDATE WORK MODAL -->
<div id="updateWorkModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
...
<div id="updateIntModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
		...
		<div class="modal-content">
			<form id="addDispForm" class="needs-validation">
				...
				<div class="modal-body">
					<div class="row">
						<div class="col">
							<select id="displacementDropdown" class="form-control input selectpicker" data-style="userSelectPicker" data-live-search="true" multiple style="width: 100%" name="displacementIds">
...
<script>
	...
	$(document).ready(function() {
		...
		var dTableExpenses = $('#dTableExpenses').DataTable({
			...
			"serverSide": true,
			"pageLength": 7,
			"ajax": "/projects/${project.id}/expenses/dt",
			"rowId": "es_id",
			"language": {
				"url": "/ui/static/lang/datatables/${locale}.json"
			},
...
// 				{ "orderable": false, "targets": 2 },
				{ "defaultContent": "${tableExpenseActionButtons}", "orderable": false, "targets": -1 }
			],
			"dom": "<'top'i>rt<'bottom'p><'clear'>",
			"drawCallback": function(settings, json) {
	...
	function canValidate(status) {
		...
		if (pending || paid || rejected) {
			return false;
		} else if (approved && (roleId == ${jspUtil.getRolId('ROLE_JEFE_PROJECTO')} || roleId == ${jspUtil.getRolId('ROLE_ADMIN')})) { // PL/Admin can approve
			return true;
		}
	...
	function parseExpenseActionButtons() {
		...
		tableRows.each(function() {
			...
			emList.each(function(index) {
				...
				if (index == 0) { // view
					$(this).wrap('<a href="/projects/${project.id}/expenses/' + expenseId + '/view"></a>');
				} else if (index == 1) { // validate
