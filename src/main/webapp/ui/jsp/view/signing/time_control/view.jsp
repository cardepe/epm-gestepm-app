			...
			<div class="col-md-12 col-lg-4">
				<form>
					<div class="form-row">
						...
						<button id="resetButton" type="button" class="btn btn-danger btn-sm" style="margin-right: 3px" onclick="resetTimeControl()">
							<span class="fas fa-sync" style="font-size: 11px"></span>
						</button>
						
						<button id="nextButton" type="button" class="btn btn-primary btn-sm" onclick="updateTimeControl()">
...
<script>
	...
	function resetTimeControl() {
		$("#monthDropdown").each(function() { this.selectedIndex = 0 });
		$("#yearDropdown").each(function() { this.selectedIndex = 0 });
