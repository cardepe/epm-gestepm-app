    ...
    public ListProjectV1Operation() {
        ...
        this.generateLinksWith(
                (apiClass, req) -> apiClass.listProjectsV1(req.getMeta(), req.getLinks(), req.getExpand(), req.getOffset(), req.getLimit(),
                        req.getOrder(), req.getOrderBy(), req.getIds(), req.getNameContains(), req.getIsStation(), req.getActivityCenterIds(), req.getIsTeleworking(), req.getState(), req.getResponsibleIds()));
    }
