...
public class ExcelUtils {
	...
	public static void getLightBlueStyleWithBorders(XSSFWorkbook workbook, Row row, int startIndex, int endIndex) {
	...
	/**
	 * Global Constructor Method to get CellStyle
	 * @param workbook
	 * @param alignment
	...
	public static CellStyle getCalibriSizeStyle(XSSFWorkbook workbook, int fontSize, boolean isBold, boolean centerAlign) {
	...
	public static void setWhiteStyle(XSSFWorkbook workbook, Row row, HorizontalAlignment alignment, int startIndex, int endIndex) {
	...
	public static void setWhiteStyleTop(XSSFWorkbook workbook, Row row, HorizontalAlignment alignment, boolean isBold, boolean isItalic, int startIndex, int endIndex) {
	...
	public static void setWhiteStyleBottom(XSSFWorkbook workbook, Row row, HorizontalAlignment alignment, boolean isBold, boolean isItalic, int startIndex, int endIndex) {
	...
	public static void setWhiteStyleLRMultiRows(XSSFWorkbook workbook, Sheet sheet, int rowIndex, int rowCount, HorizontalAlignment alignment, VerticalAlignment verticalAlignment, boolean isBold, boolean isItalic, int startIndex, int endIndex) {
	...
	public static CellStyle getDeliveryNoteHeaderStyle(XSSFWorkbook workbook) {
