...
public class PaginationCriteria {
	...
	public boolean isFilterByEmpty() {
		return filterBy == null || filterBy.getMapOfFilters() == null || filterBy.getMapOfFilters().size() == 0;
	}
	...
	public boolean isSortByEmpty() {
		return sortBy == null || sortBy.getSortBys() == null || sortBy.getSortBys().size() == 0;
	}
	...
	/** The Constant BRKT_OPN. */
	private static final String BRKT_OPN = " ( ";

	/** The Constant BRKT_CLS. */
