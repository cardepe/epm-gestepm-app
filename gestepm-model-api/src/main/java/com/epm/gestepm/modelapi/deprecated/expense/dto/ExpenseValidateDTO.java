...
public class ExpenseValidateDTO {
	...
	public ExpenseValidateDTO() {
		
	}

	public ExpenseValidateDTO(Long id, String name, Long expenseSheetsCount) {
		super();
		this.id = id;
		this.name = name;
		this.expenseSheetsCount = expenseSheetsCount;
		this.expenseType = "projects";
	}
	
	public ExpenseValidateDTO(Long id, String name, Long expenseSheetsCount, String expenseType) {
		super();
		this.id = id;
		this.name = name;
		this.expenseSheetsCount = expenseSheetsCount;
