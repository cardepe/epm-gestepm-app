...
public class UserSigningRepositoryImpl implements UserSigningRepositoryCustom {
	...
	@Override
	public List<UserSigningTableDTO> findUserSigningDTOsByUserId(Long userId, PaginationCriteria pagination) {

		try {

			CriteriaBuilder cb = entityManager.getCriteriaBuilder();
			CriteriaQuery<UserSigningTableDTO> cq = cb.createQuery(UserSigningTableDTO.class);
			...
			cq.multiselect(root.get("id"), root.get("project").get("name"), root.get("startDate"), root.get("endDate"));
			...
			TypedQuery<UserSigningTableDTO> criteriaQuery = entityManager.createQuery(cq);
	...
	@Override
	public Long findUserSigningCountByUserId(Long userId) {
	...
	public List<ExpensesMonthDTO> findExpensesMonthDTOByProjectId(Long projectId, Integer year) {
		...
		try {
			...
			Expression<Time> timeDiff = cb.function("TIMEDIFF", java.sql.Time.class, root.get("endDate"), root.get("startDate"));
