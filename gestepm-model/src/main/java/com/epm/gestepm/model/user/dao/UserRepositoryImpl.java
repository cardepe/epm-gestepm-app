...
public class UserRepositoryImpl implements UserRepositoryCustom {
	...
	public List<ExpenseValidateDTO> findExpensesToValidateByUserId(Long userId) {
		...
		try {
			...
			List<Predicate> predicates = new ArrayList<>();
			predicates.add(cb.equal(usRoot.get("id"), userId));
			predicates.add(cb.equal(expenseSheetsRoot.get("status"), PersonalExpenseSheetStatusEnum.PENDING.ordinal()));
	...
	public List<ExpenseUserValidateDTO> findExpensesToPay() {
		...
		try {
			...
			List<Predicate> predicates = new ArrayList<>();
			predicates.add(cb.equal(expenseSheetsRoot.get("status"), PersonalExpenseSheetStatusEnumDto.APPROVED.ordinal()));
